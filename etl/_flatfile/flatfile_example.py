"""Example flatfile ETL job — tutorial template.
...
def process_data(self, input_tables):
    ...
    -------
    polars.DataFrame
        Persisted by ETLBase to `flatfile_<output_table_name>` (partitioned
